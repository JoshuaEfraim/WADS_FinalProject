    ...
    <div className="flex h-screen bg-background">
      ...
      >
        ...
        <div className="flex items-center justify-center h-24 w-full">
          <img src="../src/assets/logo/siloamLogo.png" alt="Logo" className="h-40 w-40 object-contain" />
        </div>
        ...
        <div className="fixed inset-y-0 left-0 z-50 w-64 bg-card shadow-lg lg:hidden flex flex-col">
          ...
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center">
              <img src="../src/assets/logo/siloamLogo.png" alt="Logo" className="h-10 w-10 object-contain mr-2" />
