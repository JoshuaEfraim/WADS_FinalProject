...
//         <CardHeader>
//           <CardTitle className="text-2xl font-bold text-primary-500">Ticket Details</CardTitle>
//         </CardHeader>
//         <CardContent className="space-y-6">
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//             <div>
//               <div className="mb-2 text-xs text-gray-500">Ticket ID</div>
//               <div className="font-mono text-sm bg-gray-100 rounded px-2 py-1">{ticket._id}</div>
//             </div>
//             <div>
//               <div className="mb-2 text-xs text-gray-500">Requested By</div>
...
//             </div>
//             <div>
//               <div className="mb-2 text-xs text-gray-500">Subject</div>
//               <div className="font-semibold text-gray-900">{ticket.subject}</div>
//             </div>
//             <div>
//               <div className="mb-2 text-xs text-gray-500">Priority</div>
...
//               <div className="bg-gray-50 rounded p-3 text-gray-800 min-h-[60px]">{ticket.description}</div>
//             </div>
//             <div>
...
//                     <SelectItem key={opt} value={opt}>{opt.replace('_', ' ').toLowerCase().replace(/\b\w/g, l => l.toUpperCase())}</SelectItem>
//                   ))}
//                 </SelectContent>
//               </Select>
//             </div>
...
//               <div className="text-sm text-gray-700">{new Date(ticket.createdAt).toLocaleString()}</div>
//             </div>
//             <div>
//               <div className="mb-2 text-xs text-gray-500">Updated At</div>
//               <div className="text-sm text-gray-700">{new Date(ticket.updatedAt).toLocaleString()}</div>
//             </div>
//           </div>
//           <div className="flex gap-4 mt-6">
//             <Button onClick={handleUpdate} disabled={!edit || saving} className="bg-primary-500 text-white px-6 py-2 rounded shadow hover:bg-primary-600 transition">
//               {saving ? 'Saving...' : 'Save Changes'}
//             </Button>
//             <Button variant="outline" onClick={() => navigate(-1)} className="px-6 py-2 rounded border border-gray-300">Back</Button>
//             {success && <span className="text-green-600 font-medium ml-4">Update successful!</span>}
//           </div>
//         </CardContent>
//       </Card>
//     </div>
